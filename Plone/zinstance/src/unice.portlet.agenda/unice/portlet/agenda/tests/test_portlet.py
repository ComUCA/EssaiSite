...
from unice.portlet.agenda import agendaportlet

from unice.portlet.agenda.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        ...
        self.assertEquals(portlet.addview,
                          'unice.portlet.agenda.AgendaPortlet')
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.agenda_tmpl = """<p><a href="%s">Home</a></p>"""

        # make a document with some realistic agenda
        ...
        self.portal['quick-links'].setText(
            self.agenda_tmpl % self.portal.portal_url())
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=agendaportlet.Assignment(
                agenda=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.agenda_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.agenda_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.agenda_tmpl % self.portal.portal_url() + "DE" \
            in output)
