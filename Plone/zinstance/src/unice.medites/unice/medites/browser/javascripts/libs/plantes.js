...
$(document).ready(function(){
    ...
    if (isChrome) {
      $(".introSeance img").attr("src","++resource++unice.medites.images/avatars/biodiversite/plantes/p1/faceAnimGrand.gif");
    }
    if (!isChrome) {
      $(".introSeance img").attr("src","++resource++unice.medites.images/avatars/biodiversite/plantes/p1/faceAnimGrand.png");
    }
})
