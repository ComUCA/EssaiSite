...
$(document).ready(function(){
    $("#teOcUn-P2 .clear").click(function () {  localStorage.removeItem('teOcUn-P2-Regles'); });
    var isChrome = /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator.vendor);
    if (isChrome) {
        $(".introSeance img").attr("src","++resource++unice.medites.images/avatars/terre-ocean-univers/ocean/p1/faceAnimGrand.gif");
    }
    if (!isChrome) {
        $(".introSeance img").attr("src","++resource++unice.medites.images/avatars/terre-ocean-univers/ocean/p1/faceAnimGrand.png");
    }
})

// demarche scientifique - teOcUn-b-2
$(function() {
...
$( function($){
    var quizMulti = {
        ...
        },
        {
            ...
            ansSel: [ "Une densité égale à celle de l’eau, donc une poussée d’Archimède égale à son poids","Une densité supérieure à celle de l’eau, donc une poussée d’Archimède inférieure à son poids" ]
        },
        {
...
$(function() {
    ...
    for (var i = 0;i < 5;i++) {
        $( "#"+idParent+"-drag0-"+i ).draggable({ revert: "invalid", snapTolerance: 20 });
        $( "#"+idParent+"-drag1-"+i ).draggable({ revert: "invalid", snapTolerance: 20 });
        $( "#"+idParent+"-drag2-"+i ).draggable({ revert: "invalid", snapTolerance: 20 });
        $( "#"+idParent+"-drag3-"+i ).draggable({ revert: "invalid", snapTolerance: 20 });
        $( "#"+idParent+"-drag4-"+i ).draggable({ revert: "invalid", snapTolerance: 20 });
        $( "#"+idParent+"-drag5-"+i ).draggable({ revert: "invalid", snapTolerance: 20 });
