...
from unice.portlet.carousel import carouselportlet

from unice.portlet.carousel.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.carousel.CarouselPortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.carousel.CarouselPortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = carouselportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = carouselportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, carouselportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = carouselportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, carouselportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.carousel_tmpl = """<p><a href="%s">Home</a></p>"""

        # make a document with some realistic carousel
        ...
        self.portal['quick-links'].setText(
            self.carousel_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or carouselportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=carouselportlet.Assignment(
                carousel=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.carousel_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.carousel_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.carousel_tmpl % self.portal.portal_url() + "DE" \
            in output)
