...
class ICarouselPortlet(IPortletDataProvider):
    ...
    dossier_carousel = schema.Choice(title=_(u"Dossier contenant l'actualité à afficher"),
        required=False,
...
class Assignment(base.Assignment):
    ...
    def __init__(self, portlet_title=u'', dossier_carousel=None, captions_hidden=None, captions_out=None, captions_block=None, display_type=[], hero_mode=None, extra_css=u'', extra_id=u'', custom_header=None, omit_header=None):
    ...
    def dossier_carousel(self):
        ...
        if folder:
            ...
            if batch:
                ...
                # if self.data.hero_mode and len(listeItems) > 0:
                #     listeItems = listeItems[0:1]
