...
from unice.portlet.a_la_une import a_la_uneportlet

from unice.portlet.a_la_une.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        ...
        self.assertEquals(portlet.addview,
                          'unice.portlet.a_la_une.A_La_UnePortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = a_la_uneportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = a_la_uneportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, a_la_uneportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, a_la_uneportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.a_la_une_tmpl = """<p><a href="%s">Home</a></p>"""

        # make a document with some realistic a_la_une
        ...
        self.portal['quick-links'].setText(
            self.a_la_une_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or a_la_uneportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=a_la_uneportlet.Assignment(
                a_la_une=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.a_la_une_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.a_la_une_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.a_la_une_tmpl % self.portal.portal_url() + "DE" \
            in output)
