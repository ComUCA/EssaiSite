...
from unice.portlet.titre import titreportlet

from unice.portlet.titre.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        portlet = getUtility(
            IPortletType,
            name='unice.portlet.titre.TitrePortlet')
        self.assertEquals(portlet.addview,
                          'unice.portlet.titre.TitrePortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = titreportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = titreportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, titreportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        # TODO: Pass any keyword arguments to the Assignment constructor
        assignment = titreportlet.Assignment()

        renderer = getMultiAdapter(
            (context, request, view, manager, assignment), IPortletRenderer)
        self.failUnless(isinstance(renderer, titreportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.titre_tmpl = """<p><a href="%s">Home</a></p>"""

        # make a document with some realistic titre
        ...
        self.portal['quick-links'].setText(
            self.titre_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or titreportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=titreportlet.Assignment(
                titre=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.titre_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.titre_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.titre_tmpl % self.portal.portal_url() + "DE" \
            in output)
