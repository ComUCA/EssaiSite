...
from unice.portlet.indicateurs import indicateursportlet

from unice.portlet.indicateurs.tests.base import TestCase
...
class TestPortlet(TestCase):
    ...
    def test_portlet_type_registered(self):
        ...
        self.assertEquals(portlet.addview,
                          'unice.portlet.indicateurs.IndicateursPortlet')

    def test_interfaces(self):
        # TODO: Pass any keyword arguments to the Assignment constructor
        portlet = indicateursportlet.Assignment()
    ...
    def test_invoke_edit_view(self):
        ...
        mapping['foo'] = indicateursportlet.Assignment()
        editview = getMultiAdapter((mapping['foo'], request), name='edit')
        self.failUnless(isinstance(editview, indicateursportlet.EditForm))
    ...
    def test_obtain_renderer(self):
        ...
        self.failUnless(isinstance(renderer, indicateursportlet.Renderer))
...
class TestRenderer(TestCase):
    ...
    def afterSetUp(self):
        ...
        self.indicateurs_tmpl = """<p><a href="%s">Home</a></p>"""

        # make a document with some realistic indicateurs
        ...
        self.portal['quick-links'].setText(
            self.indicateurs_tmpl % self.portal.portal_url())
    ...
    def renderer(self, context=None, request=None, view=None, manager=None,
        ...
        assignment = assignment or indicateursportlet.Assignment()
    ...
    def test_render_body(self):
        r = self.renderer(
            context=self.portal,
            assignment=indicateursportlet.Assignment(
                indicateurs=self.item_url_path[len(self.portal_url_path):],
                item_display=[u'body'],
            )
        )
        ...
        r.update()
        output = r.render()
        self.failUnless(self.indicateurs_tmpl % self.portal.portal_url() in output)
    ...
    def test_i18n_render_body(self):
        ...
        ql_german.setText(self.indicateurs_tmpl % self.portal.portal_url() + "DE")
        ...
        r.update()
        output = r.render()
        self.failUnless(self.indicateurs_tmpl % self.portal.portal_url() + "DE" \
            in output)
