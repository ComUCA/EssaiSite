...
class IImageLegendeePortlet(IPortletDataProvider):
    ...
    hide_captions = schema.Bool(
        title=_(u"Masquer la légende"),
        description=_('help_hide_captions',
                      default=u""),
        required=True,
        default=False)
...
class Assignment(base.Assignment):
    ...
    def __init__(self, portlet_title=u'', hide_captions=False, imagelegendee=None, extra_css=u'', extra_id=u'', custom_header=None, sous_titre=None, omit_header=None):
